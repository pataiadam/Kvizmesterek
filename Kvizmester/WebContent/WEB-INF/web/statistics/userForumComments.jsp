...
<select id="navigation">
  ...
  <option selected="true" value="${userForumURL }">Játékosok fórumhozzászólásai</option>
  ...
  <option value="${categoryMINURL }">Kategóriánkénti minimum nehézség</option>
	...
	<thead>
		...
		<th>
			...
			<th>
				Fórum bejegyzések száma
			</th>
		</tr>

	</thead>
	<c:forEach var="user" items="${actionBean.userForumComments}">
