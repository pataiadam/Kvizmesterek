...
<select id="navigation">
  ...
  <option selected="true" value="${userHighScoresByCategoryURL }">Játékosok átlagpontszáma kategóriánként</option>
  ...
  <option value="${categoryMINURL }">Kategóriánkénti minimum nehézség</option>
	...
	<thead>
		...
		<th>
			...
			<th>
				Kategórián belül helyesen megválaszolt kérdések
			</th>
		</tr>

	</thead>
	<c:forEach var="user" items="${actionBean.userHighScoresByCategory}">
		...
		<tr>
            ...
            maxIntegerDigits="3" value="${user.score}" />
			</td>
			<td class="dashColumn">
			${user.category}
			</td>
            ...
            maxIntegerDigits="3" value="${user.relativeAnswers}" />
			</td>
